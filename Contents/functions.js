...
/*property
    ...
    itemExists, landscapeHoffsetPref, landscapeVoffsetPref, onContextMenu,
    onSelect, portraitHoffsetPref, portraitVoffsetPref, push, reveal, ticking,
    title, userWidgetsFolder, vLocationPercPref, vOffset, value, visible,
    voffset, widgetHideModePref, widgetLockLandscapeModePref,
    widgetLockPortraitModePref, width
*/

"use strict";

var mainWindow, widgetName, tankHelpShow, displayLicence, theTimer, updateFlipClock;
var print, log;
...
function menuitem6OnClick() {
    ...
    if (answer === 1) {
        openURL("https://www.deviantart.com/yereverluvinuncleber/art/Dieselpunk-FlipClock-Desktop-763515461");
    }
}
//=====================
//End function
...
function setmenu() {
    mainWindow.onContextMenu = function () {
        ...
        mItem = new MenuItem();
        mItem.title = "Panzer Flip Clock Gauge Help";
        mItem.onSelect = function () {
            tankHelpShow();
        };
        items.push(mItem);
    ...
    print (preferences.imageEditPref.value);
    print (debugFlg);
