...
/*properties
    appendChild, base, centreBoss, clock, clockReflection, hrsOfWeek,
    displayTime, floor, frame, gethrs, getHours, getMinutes, getSeconds, hOffset,
...
function flipClockGauge(parent, hOffset, vOffset, zOrder, scale, visible) {
    var newImage = function (parent, hOffset, vOffset, width, height, src, zOrder, opacity, hRegP, vRegP) {
        ...
        left0 = newImage(frame, 269, 206, 132, 177, base + "left0.png", zOrder, 0),
        ...
        right0 = newImage(frame, 409, 206, 132, 177, base + "right0.png", zOrder, 0),
        ...
        face = newImage(frame, 137, 34, 554, 548, base + "facehrs.png", zOrder, 255),
        surround = newImage(frame, 0, 0, 770, 660, base + "surround.png", zOrder, 255),
        startButton = newImage(frame, 710, 135, 95, 95, base + "startButton.png", zOrder, 255),
        stopButton = newImage(frame, 710, 395, 95, 95, base + "startButton.png", zOrder, 255),
        switchFacesButton = newImage(frame, 710, 267, 95, 95, base + "startButton.png", zOrder, 255),
...
flipClockGauge.prototype.reScale = function (scale) {
    ...
    scaleImage(this.left0, 269, 206, 132, 177);
    ...
    scaleImage(this.right0, 409, 206, 132, 177);
...
/*
flipClockGauge.prototype.displayTime = function (d) {
    function weekhrsOf(d) {
        var dow = ["Sunhrs", "Monhrs", "Tueshrs", "Wedneshrs", "Thurshrs", "Frihrs", "Saturhrs"];
    ...
    this.hrsOfWeek.src = this.base + dow + ".png";
};
*/